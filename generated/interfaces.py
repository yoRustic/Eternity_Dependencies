...
class steamclient64_dll: # steamclient64.dll
    IVALIDATE001 = 0x8657B0
    CLIENTENGINE_INTERFACE_VERSION005 = 0x861720
    SteamClient021 = 0x662D50
    SteamClient020 = 0x662D40
    SteamClient019 = 0x662D30
    SteamClient018 = 0x662D20
    SteamClient017 = 0x662D10
    SteamClient016 = 0x662D00
    SteamClient015 = 0x662CF0
    SteamClient014 = 0x662CE0
    SteamClient013 = 0x662CD0
    SteamClient012 = 0x662CC0
    SteamClient011 = 0x662CB0
    SteamClient010 = 0x662CA0
    SteamClient009 = 0x662C90
    SteamClient008 = 0x662C80
    SteamClient007 = 0x662C70
    SteamClient006 = 0x662C60
    p2pvoice002 = 0xD9F30
    p2pvoicesingleton002 = 0xD6990
